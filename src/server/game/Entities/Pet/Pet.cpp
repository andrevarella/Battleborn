        ...
        default:
            {
                switch (GetEntry())
                {
                    ...
                    case NPC_INFERNAL:
                        {
                            float highAmt = petlevel / 6.5f;
                            float lowAmt = petlevel / 7.0f;
...
{    
    ...
    if (ctFamily && (ctFamily == CREATURE_FAMILY_DEVILSAUR || ctFamily == CREATURE_FAMILY_RHINO || ctFamily == CREATURE_FAMILY_CORE_HOUND))
